    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          Animedex.pp.ua is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on Animedex.pp.ua are hosted on our servers. All
          ...
          to{" "}
          <Link href="mailto:contact@Animedex.pp.ua" className="text-white">
