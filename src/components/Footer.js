        ...
        <div>
            <footer className="bg-[#151518] mt-10">
                    ...
                    <div className="lg:flex lg:justify-between">
                        <div class="mb-6 lg:mb-0">
                            <Link class="flex items-center w-fit" href="/">
                                <p class="Animedex self-center !text-4xl tracking-wider font-medium whitespace-nowrap dark:text-white">Animedex</p>
                                </Link>
                        ...
                        <div className="grid grid-cols-2 lg:gap-16 sm:gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                <ul className="font-semibold flex flex-col gap-2 lg:text-[0.85rem] text-[0.7rem] text-[#ffffffb2]">
                                    ...
                                    <li>
                                        <Link href="https://ko-fi.com/skgupta507" target='_blank' className="hover:text-white !font-semibold !text-[0.8rem]">Donate</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="mx-auto w-full lg:max-w-[83%] lg:flex lg:items-center lg:justify-between lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] py-3">
                    <span className="sm:text-center ms-5 lg:ms-0">© {year} <Link href="/" className="hover:text-white">Animedex™</Link> | Made by <span className="font-bold" >SK Gupta</span>
                    </span>
                    <div className="flex mt-4 lg:justify-center lg:mt-0">
                        <Link href="https://github.com/skgupta507/Animedex" target="_blank" className=" hover:text-gray-900 dark:hover:text-white ms-5 lg:ms-0">
                        ...
                        <Link href="https://discord.gg/skgupta507" target="_blank" className=" hover:text-gray-900 dark:hover:text-white ms-5">
